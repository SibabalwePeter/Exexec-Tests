...
export default class Client {
    constructor () {
        ...
        this.cheIsLinemanager = Selector('[data-datafield=IsLineManager]')
        ...
        // Line manager
        this.icoReport = Selector('#side-menu > div > div:nth-child(7) > span')
        this.dropReport = Selector('[data-datafield=SelectedReportID]')
        this.dropReportChoice = Selector('body > div.ComboDropDown > div > div')
